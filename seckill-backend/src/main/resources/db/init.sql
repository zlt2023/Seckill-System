...
-- 插入测试商品
INSERT INTO `t_goods` (`goods_name`, `goods_title`, `goods_img`, `goods_detail`, `goods_price`, `goods_stock`, `status`) VALUES
('iPhone 16 Pro Max', 'Apple iPhone 16 Pro Max 256GB 沙漠钛金属', 'https://picsum.photos/id/1/400/400', '全新 A18 Pro芯片，超强性能。4800万像素四合一主摄，支持5倍光学变焦。钛金属设计，超瓷晶面板。', 9999.00, 1000, 1),
('MacBook Pro M4', 'Apple MacBook Pro 14英寸 M4芯片 16GB+512GB', 'https://picsum.photos/id/2/400/400', 'M4芯片带来突破性性能，Liquid Retina XDR显示屏，长达18小时电池续航。', 12999.00, 500, 1),
('AirPods Pro 3', 'Apple AirPods Pro 第三代 主动降噪', 'https://picsum.photos/id/3/400/400', '全新H3芯片，自适应降噪，个性化空间音频，USB-C充电盒，长达30小时续航。', 1999.00, 2000, 1),
('iPad Air M3', 'Apple iPad Air 11英寸 M3芯片 256GB', 'https://picsum.photos/id/4/400/400', 'M3芯片驱动，11英寸Liquid Retina显示屏，支持Apple Pencil Pro。', 5499.00, 800, 1),
('Sony PS5 Pro', 'Sony PlayStation 5 Pro 游戏主机', 'https://picsum.photos/id/5/400/400', '全新GPU架构，支持8K游戏，光线追踪，2TB SSD存储，向下兼容PS4/PS5游戏。', 4999.00, 300, 1),
('华为 Mate 70 Pro+', '华为 Mate 70 Pro+ 麒麟芯片 512GB', 'https://picsum.photos/id/6/400/400', '麒麟旗舰芯片，超感知影像系统，卫星通信，鸿蒙操作系统，超长续航。', 8999.00, 600, 1);

-- 插入秒杀商品 (活动时间设为当前时间至未来7天)
INSERT INTO `t_seckill_goods` (`goods_id`, `seckill_price`, `stock_count`, `start_date`, `end_date`, `status`) VALUES
(1, 6999.00, 100, NOW(), DATE_ADD(NOW(), INTERVAL 7 DAY), 1),
(2, 8999.00, 50,  NOW(), DATE_ADD(NOW(), INTERVAL 7 DAY), 1),
(3, 999.00,  200, NOW(), DATE_ADD(NOW(), INTERVAL 7 DAY), 1),
(4, 3999.00, 80,  NOW(), DATE_ADD(NOW(), INTERVAL 7 DAY), 1),
(5, 3499.00, 30,  DATE_ADD(NOW(), INTERVAL 1 DAY), DATE_ADD(NOW(), INTERVAL 8 DAY), 1),
(6, 5999.00, 60,  DATE_ADD(NOW(), INTERVAL 2 DAY), DATE_ADD(NOW(), INTERVAL 9 DAY), 1);
